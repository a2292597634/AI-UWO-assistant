...
describe('Full data integrity', () => {
  ...
  const screenshotOfficerFixtures: Array<{
    name: string
    fields: Partial<CanonicalOfficer>
    languages: CanonicalOfficer['languages']
    skills: CanonicalOfficer['skills']
  }> = [
    {
      name: '梅拉蒂',
      fields: {
        id: 'officer_wo_offline_melati',
        name: '梅拉蒂',
        rarityId: 'rarity_5',
        visualGradeId: 'grade_5',
        typeId: 'type_class_2',
        genderId: 'gender_f',
        jobId: 'job_job21401008',
        nationalityId: 'nationality_ctn_maj',
        displayOrder: 634,
        recruitment: {
          cityIds: [],
          requirementId: null,
        ...
        portraitId: null,
        sourceRefs: { workOrderId: 'wo_offline_melati' },
        maintenanceNote: '手動新增 — 2026-09-18',
      },
      languages: [
        { languageId: 'language_lang100', level: 5 },
        { languageId: 'language_lang330', level: 3 },
      ],
      skills: [
        {
    ...
    },
    {
      name: '安東尼奧·馬拉泰斯塔',
      fields: {
        id: 'officer_wo_offline_antonio_malatesta',
        name: '安東尼奧·馬拉泰斯塔',
        rarityId: 'rarity_4',
        visualGradeId: 'grade_4',
        typeId: 'type_class_3',
        genderId: 'gender_m',
        jobId: 'job_job21400012',
        nationalityId: 'nationality_ctn_ntc',
        displayOrder: 635,
        recruitment: {
          cityIds: [],
        ...
        portraitId: null,
        sourceRefs: { workOrderId: 'wo_offline_antonio_malatesta' },
        maintenanceNote: '手動新增 — 2026-09-18',
      },
      languages: [
        { languageId: 'language_lang80', level: 3 },
        { languageId: 'language_lang30', level: 2 },
      ],
      skills: [
        {
          skillId: 'skill_skill400591',
    ...
    },
    {
      name: '路易絲·德·波瓦桑',
      fields: {
        id: 'officer_wo_offline_louise_de_poisson',
        name: '路易絲·德·波瓦桑',
        rarityId: 'rarity_5',
        visualGradeId: 'grade_5',
        typeId: 'type_class_1',
        genderId: 'gender_f',
        jobId: 'job_job21402004',
        nationalityId: 'nationality_ctn_fra',
        displayOrder: 636,
        recruitment: {
          cityIds: [],
          requirementId: null,
        ...
        portraitId: null,
        sourceRefs: { workOrderId: 'wo_offline_louise_de_poisson' },
        maintenanceNote: '手動新增 — 2026-09-18',
      },
      languages: [
        { languageId: 'language_lang40', level: 5 },
        { languageId: 'language_lang270', level: 3 },
      ],
      skills: [
        {
          skillId: 'skill_skill400521',
    ...
    },
    {
      name: '瓦倫蒂娜·莫雷爾',
      fields: {
        id: 'officer_wo_offline_valentina_morel',
        name: '瓦倫蒂娜·莫雷爾',
        rarityId: 'rarity_5',
        visualGradeId: 'grade_5',
        typeId: 'type_class_2',
        genderId: 'gender_f',
        jobId: 'job_job21401009',
        nationalityId: 'nationality_ctn_ntc',
        displayOrder: 637,
        recruitment: {
          cityIds: [],
        ...
        portraitId: null,
        sourceRefs: { workOrderId: 'wo_offline_valentina_morel' },
        maintenanceNote: '手動新增 — 2026-09-18',
      },
      languages: [
        { languageId: 'language_lang80', level: 5 },
        { languageId: 'language_lang290', level: 3 },
      ],
      skills: [
        {
          skillId: 'skill_skill400471',
          kind: 'active',
          sourceGroup: 'sk2',
          slot: 0,
          unlockLevel: 1,
    ...
    },
    {
      name: '賈科莫·德·坎帕尼亞',
      fields: {
        id: 'officer_wo_offline_giacomo_de_campania',
        name: '賈科莫·德·坎帕尼亞',
        rarityId: 'rarity_5',
        visualGradeId: 'grade_5',
        typeId: 'type_class_2',
        genderId: 'gender_m',
        jobId: 'job_job21401010',
        nationalityId: 'nationality_ctn_ntc',
        displayOrder: 638,
        recruitment: {
          cityIds: [],
        ...
        portraitId: null,
        sourceRefs: { workOrderId: 'wo_offline_giacomo_de_campania' },
        maintenanceNote: '手動新增 — 2026-09-18',
      },
      languages: [
        { languageId: 'language_lang80', level: 5 },
  ...
  it.each(screenshotOfficerFixtures)('$name 的截圖資料符合錄入規範', (fixture) => {
    const officer = officers.find((item) => item.name === fixture.name)

    expect(officer).toMatchObject(fixture.fields)
    expect(officer?.languages).toEqual(fixture.languages)
    expect(officer?.skills).toEqual(fixture.skills)
  })
