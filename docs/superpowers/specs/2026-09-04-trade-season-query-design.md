...
以中國大陸時間的日曆日為基準，假設每日 09:00（中國大陸時間）換算到下一個遊戲月份：

- 2026-09-03 09:00（中國大陸時間）對應遊戲內 12 月；
- 2026-09-07 09:00（中國大陸時間）起對應遊戲內 4 月；
...
計算定義：
    ...
    anchor = 2026-09-03T09:00:00+08:00
    deltaDays = floor((now - anchor) / 1 日)
    gameMonth = ((deltaDays + 11) mod 12 + 12) mod 12 + 1

實作時使用 UTC timestamp 加固定 +08:00 基準，將中國大陸 09:00 表示為 UTC 01:00，避免 Date 直接取本地年月日造成時區差異。
...
- 月份表頭與港口儲存格對齊；
- 2026-09-07 09:00（中國大陸時間）起顯示遊戲 4 月；
...
- 遊戲月份以 2026-09-03 09:00（中國大陸時間）＝12 月為基準正確循環；
